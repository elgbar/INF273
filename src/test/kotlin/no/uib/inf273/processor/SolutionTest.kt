...
internal class SolutionTest {
    ...
    fun getVesselRanges_sol4() {
        ...
        assertEquals(subArrays, sol.getVesselRanges(false))
    }
    ...
    internal fun objval_random() {
        ...
        Main.log.debug { "length of solution is ${arr.size}" }
        var index = 0
    ...
    internal fun joinToArray_exch() {
        ...
        val newSub = sol.splitToSubArray(true)
